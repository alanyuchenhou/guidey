...
public class ReverseGeocodingFragment extends ExampleFragment<ReverseGeocodingPresenter> {

    @Override
    protected ReverseGeocodingPresenter createPresenter() {
        return new ReverseGeocodingPresenter();
    }
