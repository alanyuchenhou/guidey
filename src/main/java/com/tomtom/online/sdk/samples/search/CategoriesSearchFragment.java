...
public class CategoriesSearchFragment extends SearchFragment {
    ...
    public void onLeftButtonClicked() {
        ...
        searchPresenter.performSearch(Category.OpenParkingArea.getQuery());
    }

    @Override
    public void onRightButtonClicked() {
        disableToggleButtons();
        ((CategoriesSearchFragmentPresenter)searchPresenter).performSearch(Category.Atm);
    }

    @Override
    public void onFirstMiddleButtonClicked() {
        disableToggleButtons();
        searchPresenter.performSearch(Category.PetrolStation.getQuery());
    }
