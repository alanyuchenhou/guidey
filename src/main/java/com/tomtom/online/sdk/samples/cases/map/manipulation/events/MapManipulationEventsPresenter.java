...
public class MapManipulationEventsPresenter extends BaseFunctionalExamplePresenter {
    ...
    private TomtomMapCallback.MapViewPortChanged onMapViewPortChangedListener =
    ...
    private void setupRxTomtomMap() {
        ...
        Disposable mapClickDisposable = rxTomtomMap.getOnMapClickObservable().subscribe(new Consumer<LatLng>() {
            @Override
