...
import com.tomtom.online.sdk.samples.cases.route.EtaPanelHolder;
import com.tomtom.online.sdk.samples.fragments.FunctionalExampleFragment;
import com.tomtom.online.sdk.samples.utils.views.OptionsButtonsView;

public abstract class ExampleFragment<T extends FunctionalExamplePresenter> extends Fragment implements FunctionalExampleFragment, OptionsButtonsView.OptionsChangeValue {
    ...
    private EtaPanelHolder etaPanelHolder;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        etaPanelHolder = new EtaPanelHolder(view.findViewById(R.id.sample_eta_panel));
    ...
    protected EtaPanelHolder getEtaPanelHolder(){
        return etaPanelHolder;
    }
